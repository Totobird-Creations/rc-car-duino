// SOURCE https://github.com/chrisjpalmer/rust-arduino-servo
...
impl Servo {
    pub fn new(
        d9  : arduino_hal::port::Pin<arduino_hal::port::mode::Input<arduino_hal::port::mode::Floating>, atmega_hal::port::PB1>,
        tc1 : avr_device::atmega328p::TC1
    ) -> Self {
